...
export function CinematicHero() {
  return (
    <section className="relative h-screen min-h-[700px] w-full flex items-center justify-center overflow-hidden">
      ...
      {/* Mid-layer parallax decorative elements */}
      <Parallax offset={80} className="absolute inset-0 z-[1]">
        <FloatingDecor
          variant="lotus"
          className="top-[15%] left-[10%] text-white"
          size={100} />
        
        <FloatingDecor
          variant="geometric"
          className="top-[60%] right-[8%] text-accent"
          size={120} />
        
        <FloatingDecor
          variant="leaf"
          className="bottom-[20%] left-[15%] text-white"
          size={90} />
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 text-center">
        <motion.div
          ...
          <p className="text-xl md:text-2xl text-white/95 mb-12 max-w-3xl mx-auto font-light leading-relaxed text-balance">
            Discover Sri Lanka through curated experiences, private journeys,
            and unforgettable moments crafted exclusively for discerning
            travellers.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16">
            <Link
              to="/tours"
              className="group w-full sm:w-auto px-10 py-5 bg-accent text-white rounded-full font-semibold text-lg hover:bg-accent/90 transition-all duration-300 shadow-lift hover:shadow-glass-strong hover:-translate-y-1">
              
              Explore Journeys
            </Link>
            <Link
              to="/trip-planner"
              className="group w-full sm:w-auto px-10 py-5 glass-panel-dark text-white rounded-full font-semibold text-lg hover:bg-white/20 transition-all duration-300">
