      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <motion.div
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Boutique hotels, heritage bungalows, and exclusive resorts
            handpicked for their exceptional service and unique character.
          </p>
        </motion.div>
            ...
            className="group">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-card hover:shadow-lift transition-all duration-500">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <p className="text-accent text-xs font-semibold mb-2 tracking-luxury uppercase">
                    {hotel.category}
                  </p>
